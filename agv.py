...
"background-color: rgb(114, 159, 207);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.linearVelocityUp.clicked.connect(self.linearVelocityUpPressed)
        #self.linearVelocityUp.released.connect(self.buttonReleased)

        self.linearVelocityDown.clicked.connect(self.linearVelocityDownPressed)
        #self.linearVelocityDown.released.connect(self.buttonReleased)

        self.AngularVelocityUp.clicked.connect(self.AngularVelocityUpPressed)
        #self.AngularVelocityUp.released.connect(self.buttonReleased)

        self.angularVelocityDown.clicked.connect(self.angularVelocityDownPressed)
        #self.angularVelocityDown.released.connect(self.buttonReleased)

        
        rospy.Subscriber('/cmd_vel', Twist,self.callback2, queue_size=100)
        self.twist = Twist()
    ...
    def callback2(self,twist1):
        self.twist.linear.x = twist1.linear.x
        self.twist.angular.z = twist1.angular.z
        self.instantaneousVelocityX.setText(str(round(twist1.linear.x,3)))
        self.instantaneousVelocityY.setText(str(round(twist1.angular.z,3)))
